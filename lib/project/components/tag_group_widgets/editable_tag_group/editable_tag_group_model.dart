...
class EditableTagGroupModel extends FlutterFlowModel {
  ...
  // Model for Default_Tag component.
  late DefaultTagModel defaultTagModel4;
  // Model for Default_Tag component.
  late DefaultTagModel defaultTagModel5;
  // Model for Default_Tag component.
  late DefaultTagModel defaultTagModel6;
  ...
  void initState(BuildContext context) {
    ...
    defaultTagModel4 = createModel(context, () => DefaultTagModel());
    defaultTagModel5 = createModel(context, () => DefaultTagModel());
    defaultTagModel6 = createModel(context, () => DefaultTagModel());
  }
  ...
  void dispose() {
    ...
    defaultTagModel4.dispose();
    defaultTagModel5.dispose();
    defaultTagModel6.dispose();
  }
