...
import 'choose_tag_popup_model.dart';
export 'choose_tag_popup_model.dart';

class ChooseTagPopupWidget extends StatefulWidget {
  const ChooseTagPopupWidget({Key? key}) : super(key: key);

  @override
  _ChooseTagPopupWidgetState createState() => _ChooseTagPopupWidgetState();
}

class _ChooseTagPopupWidgetState extends State<ChooseTagPopupWidget> {
  late ChooseTagPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChooseTagPopupModel());
  }
