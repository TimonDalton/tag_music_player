...
import 'trim_queue_page_model.dart';
export 'trim_queue_page_model.dart';

class TrimQueuePageWidget extends StatefulWidget {
  const TrimQueuePageWidget({Key? key}) : super(key: key);

  @override
  _TrimQueuePageWidgetState createState() => _TrimQueuePageWidgetState();
}

class _TrimQueuePageWidgetState extends State<TrimQueuePageWidget> {
  late TrimQueuePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TrimQueuePageModel());
  }
