...
import 'add_queue_page_model.dart';
export 'add_queue_page_model.dart';

class AddQueuePageWidget extends StatefulWidget {
  const AddQueuePageWidget({Key? key}) : super(key: key);

  @override
  _AddQueuePageWidgetState createState() => _AddQueuePageWidgetState();
}

class _AddQueuePageWidgetState extends State<AddQueuePageWidget> {
  late AddQueuePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddQueuePageModel());
  }
            ...
            children: [
              ...
              wrapWithModel(
                ...
                child: BottomOptionsBarWidgetWidget(
                  confirmText: 'Add\nSelected',
                  confirmColour: FlutterFlowTheme.of(context).success,
                ),
              ),
            ],
          ),
